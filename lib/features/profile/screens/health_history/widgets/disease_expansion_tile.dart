...
class DiseaseExpansionTile extends StatelessWidget {
  const DiseaseExpansionTile({super.key});
    ...
    Container(
      ...
      child: Theme(
        ...
        child: ExpansionTile(
          ...
          title: Text('Disease History', style: MTextTheme.regular.copyWith(color: MColors.primaryColor)),
          ...
          children: [
            _buildOption('Allergy History'),
            SizedBox(height: 8.h), // spacing between each option row
            _buildOption('Surgery History'),
            SizedBox(height: 8.h),
            _buildOption('History of Drugs Consumed'),
          ],
        ),
      ),
    );
